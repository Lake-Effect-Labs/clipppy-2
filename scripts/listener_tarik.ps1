            ...
            # Configure window
            $Host.UI.RawUI.WindowTitle = 'Clipppy - TARIK'
...
"@
            ...
            try {
                ...
                python twitch_clip_bot.py start --streamer tarik --always-on-mode 2>&1 | Tee-Object -FilePath "logs/listener_tarik.log"
            } catch {
...
try {
    cd 'C:\Users\samfi\OneDrive\Desktop\cursor projects\clipppy 2'
    python twitch_clip_bot.py start --streamer tarik --always-on-mode
} catch {
