            ...
            # Configure window
            $Host.UI.RawUI.WindowTitle = 'Clipppy - CAEDREL'
...
"@
            ...
            try {
                ...
                python twitch_clip_bot.py start --streamer caedrel --always-on-mode 2>&1 | Tee-Object -FilePath "logs/listener_caedrel.log"
            } catch {
...
try {
    cd 'C:\Users\samfi\OneDrive\Desktop\cursor projects\clipppy 2'
    python twitch_clip_bot.py start --streamer caedrel --always-on-mode
} catch {
