            ...
            # Configure window
            $Host.UI.RawUI.WindowTitle = 'Clipppy - SUMMIT1G'
...
"@
            ...
            try {
                ...
                python twitch_clip_bot.py start --streamer summit1g --always-on-mode 2>&1 | Tee-Object -FilePath "logs/listener_summit1g.log"
            } catch {
...
try {
    cd 'C:\Users\samfi\OneDrive\Desktop\cursor projects\clipppy 2'
    python twitch_clip_bot.py start --streamer summit1g --always-on-mode
} catch {
